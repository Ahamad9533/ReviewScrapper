...
# Step 1: pip install selenium webdriver-manager requests
# Step 2: Make sure you have Chrome installed on your machine
# Step 3: Check your Chrome version (go to the three dots, then Help, then About Google Chrome)

search_term = 'kia'
# Number of images you can pass from here; by default, it's 10 if you are not passing
# number_images = 50
search_and_download(search_term=search_term, number_images=10)



## Try to store all of this images in Mango DB.
## Try to implement it with class and object.
## coding standards.
## write a function for fetch all the images based on their name form data base.
## Try to modify a code so that i will first search in data base and check if images are available for a respective search if not then only scrap
